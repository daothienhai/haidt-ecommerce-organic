          ...
          >
            ...
            {Array.from({ length: totalPages }).map((el, index) => (
              <div
                ...
                aria-current="page"
                className={`relative cursor-pointer z-10 inline-flex items-center border border-gray-300 ${
                  index + 1 === page
                    ? "bg-lime-600 text-white"
                    : "text-gray-400"
                } px-4 py-2 text-sm font-semibold border border-gray-300  focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lime-600`}
              >
                {index + 1}
              </div>
            ))}

              ...
              <div className="lg:col-span-3">
                <div>
                  <Link
                    ...
                    className="rounded-md mx-10 my-5 bg-green-700 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lime-600"
                  >
                    Add New Product
                  </Link>
                </div>
              ...
              <div
                ...
                className={`relative cursor-pointer z-10 inline-flex items-center ${
                  index + 1 === page
                    ...
                    : "text-gray-400"
                } px-4 py-2 text-sm font-semibold  focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lime-600`}
              >
                {index + 1}
              </div>
            ))}
            ...
            <div>
              <Link to={`/product-detail/${product.id}`} key={product.id}>
                <div className="group relative ">
                  <div className=" min-h-60 aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md lg:aspect-none group-hover:opacity-75 lg:h-60">
                    <img
                      src={
                        product.thumbnail ? product.thumbnail : fallbackImage
                      }
                      alt={product.title}

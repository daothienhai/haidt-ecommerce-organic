      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          <div className="lg:col-span-3">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          {...register("phone", {
                            ...
                            pattern: {
                              value: /^[0-9]*$/, // Chỉ chấp nhận số
                              message: "Phone not valid",
                            },
                            minLength: {
                              value: 10, // Độ dài tối thiểu là 10 ký tự
                              message: "Phone must have at least 10 digits",
                            },
                            maxLength: {
                              value: 10, // Độ dài tối đa là 10 ký tự
            ...
            <div className="border-b border-gray-900/10 pb-12">
              <h2 className="mt-3 text-base font-semibold leading-7 text-gray-900">
                Addresses
              </h2>
              ...
              <ul>
                {user.addresses.map((address, index) => (
                  <li
                    key={index}
                    className="mb-3 flex justify-between gap-x-6 px-5 py-5 border-solid border border-gray-300"
                  >
            ...
            <div className="mx-auto mt-12 bg-white max-w-7xl px-2 sm:px-2 lg:px-4">
                    ...
                    {items.map((item) => (
                      <li key={item.id} className="flex py-6">
                        <div className="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                          <img
                            src={
                              item.thumbnail ? item.thumbnail : fallbackImage
                            }
                            alt={item.title}
              ...
              <div className="border-t border-gray-200 px-2 py-6 sm:px-2">
                ...
                <div className="mt-6">
                  <div
                    onClick={handleOrder}
                    className="flex cursor-pointer items-center justify-center rounded-md border border-transparent bg-lime-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-lime-700"
                  >
                    Order Now
                  </div>
                </div>
